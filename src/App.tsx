                ...
                <div className="relative z-10 max-w-7xl mx-auto w-full">
                    ...
                    >
                        <p className="text-xl md:text-2xl text-white/70 mb-12 font-light leading-relaxed">
                            Bold brands deserve bold design. We build websites and create content that turns heads and drives results.
                        </p>
                        ...
                        <div className="space-y-12">
                            <div className="group border-b border-white/10 pb-12 hover:border-north-accent transition-colors duration-500">
                                ...
                                <p className="text-white/70 leading-relaxed">
                                    Built for volume. We have the systems and processes to produce high-quality short-form content consistently across TikTok, Reels, and Shorts. We handle the production so you can handle the growth.
                                </p>
                            </div>
